...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="mt-3">
        ...
        <div class="mt-3">
            <asp:LinkButton runat="server" CssClass="btn btn-primary col-1" ID="btnConfirm">Yes</asp:LinkButton>
            <asp:LinkButton runat="server" CssClass="btn btn-secondary col-1" ID="btnCancel">No</asp:LinkButton>
        </div>
</asp:Content>
