...
namespace Blue_Fish
{
    public partial class InventoryList : System.Web.UI.Page
    {
        ...
        private void MakeTable(DataRow r)
        {
            ...
            details.Text =
            "<a href='#?id=" + r.Field<int>("id") + "' title='Details' class='btn btn-sm'>" +
            ...
            edit.Text =
            "<a href='#?id=" + r.Field<int>("id") + "' title='Edit' class='btn btn-sm'>" +
                "<svg style='width:24px;height:24px' viewBox='0 0 24 24'>" +
            ...
            delete.Text =
            "<a href='#?id=" + r.Field<int>("id") + "' title='Delete' class='btn btn-sm'>" +
                "<svg style='width:24px;height:24px' viewBox='0 0 24 24'>" +
