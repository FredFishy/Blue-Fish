...
namespace Blue_Fish
{
    public partial class RepairList : System.Web.UI.Page
    {
        ...
        private void MakeTable(DataRow r)
        {
            ...
            DateTime result;
            dateOut.Text = (DateTime.TryParse(r.ItemArray[2].ToString(), out result) ? result.ToShortDateString() : "Incomplete");
            ...
            details.Text =
            "<a href='EmpDetails.aspx/?id=" + r.Field<int>("id") + "' title='Details' class='btn btn-sm'>" +
