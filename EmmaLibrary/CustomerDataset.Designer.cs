...
namespace EmmaLibrary {
    ...
    public partial class CustomerDataset : global::System.Data.DataSet {
        ...
        public partial class CustomerSalesDataTable : global::System.Data.TypedTableBase<CustomerSalesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CustomerSalesRow AddCustomerSalesRow(string orlNote, System.DateTime ordDate, decimal ordTotal, int custID) {
...
SELECT id, custFirst, custLast, custPhone, custAddress, custCity, custPostal, custEmail FROM customer WHERE (id = @id)";
    ...
    public partial class CustomerSalesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        receipt.id, order_line.orlNote, receipt.ordDate, SUM(order_line.orlPrice) AS ordTotal, receipt.custID
FROM            receipt INNER JOIN
                         order_line ON receipt.id = order_line.receiptID
GROUP BY receipt.id, receipt.ordDate, order_line.orlNote, receipt.custID
