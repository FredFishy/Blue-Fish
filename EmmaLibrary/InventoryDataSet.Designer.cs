...
namespace EmmaLibrary {
    ...
    public partial class InventoryDataSet : global::System.Data.DataSet {
        ...
        public partial class prod_orderDataTable : global::System.Data.TypedTableBase<prod_orderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public prod_orderRow Addprod_orderRow(string pordNumber) {
...
FROM            inventory INNER JOIN
    ...
    public partial class prod_orderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [prod_order] ([pordNumber]) VALUES (@pordNumber)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        TOP (1) pordNumber\r\nFROM            prod_order\r\nORDER BY pordNumber" +
                " DESC";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InventoryDataSet.prod_orderDataTable dataTable) {
        ...
        public virtual int Insert(string pordNumber) {
            if ((pordNumber == null)) {
